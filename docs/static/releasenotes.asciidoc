...
=== Logstash Commits between 7.13.0 and 7.12.1

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.12.1..7.13.0"

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.12.1..7.13.0 *.release"

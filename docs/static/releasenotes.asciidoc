...
=== Logstash Commits between 7.12 and 7.11.2

Computed with "git log --pretty=format:'%h -%d %s (%cr) <%an>' --abbrev-commit --date=relative v7.11.2..7.12"

a0a95c823 - (HEAD -> 7.12, upstream/7.12) Backport PR #12685 to 7.12: Fix Elasticsearch/DLQ integration test flakiness (#12823) (5 days ago) <Karol Bucek>
eb3e4afd7 - Deps: bump lock file for 7.12.1 (#12822) (5 days ago) <Karol Bucek>
c424f990f - updated distributor pattern section (#12810) (6 days ago) <Ahil PonArul>
2abdc3f4a - Allow plugin manager uninstall plugin regardless of working directory (#12786) (#12809) (11 days ago) <kaisecheng>
4676aa886 - Backport PR #12784 (#12805) to 7.12: Fix: logstash-keystore failing with an error (#12804) (11 days ago) <Karol Bucek>
fb0c42d22 - Set correct permissions for /usr/share/logstash on pkg installs (#12782) (#12789) (3 weeks ago) <Andres Rodriguez>
58dd011b1 - Build: avoid leaking memory from generate_plugins_version (#12763) (#12773) (4 weeks ago) <Karol Bucek>
2d4468215 - Doc: Rework security update in release notes (#12768) (4 weeks ago) <Karen Metts>
9b4e60298 - Release notes for 7.12.0 (#12683) (4 weeks ago) <Logstash Machine>
76fc176da - Release: bump version to 7.12.1 (#12764) (4 weeks ago) <Karol Bucek>
ec7808b3e - Doc:Add placeholder and coming tag for 7.12.0 release notes (#12762) (4 weeks ago) <Karen Metts>
3c5c5a150 - Forwardport release notes for 7.11.1 and 7.11.2 to 7.12 branch (#12743) (4 weeks ago) <Karen Metts>
4399d72a9 - (tag: v7.12.0) Doc: Change protocol from HTTP to HTTPS for 7.12 (#12754) (5 weeks ago) <Karen Metts>
2926f1e8c - internal-monitoring: use configured ssl verification mode (#12749) (#12751) (5 weeks ago) <Ry Biesemeyer>
0f7a0dcbd - Removes the "Snapshot builds" section from README.md for 7.11 branch like #12682 done for 7.12 (#12739) (6 weeks ago) <Andrea Selva>
c784499a0 - Docs: Replace relative paths with docs-root attributes (#12732) (6 weeks ago) <Karen Metts>
e5348bf66 - update jdk to 11.0.10+9 (#12693) (#12701) (7 weeks ago) <João Duarte>
86f7c3d78 - (upstream/7.12_preview) Update minor plugin versions in gemfile lock for 7.12.0 (#12681) (9 weeks ago) <Logstash Machine>
78f155825 - Add lock file for 7.12.0 (9 weeks ago) <Joao Duarte>
567487fdc - Make integration test fail if 'offline' tool can't be compiled (9 weeks ago) <andsel>
275abab17 - Fix Logstash pipelines management in case of slow loading pipelines or disabled webserver (#12571) (9 weeks ago) <andsel>
4e82485d3 - Separate "not terminated" pipeline state into "running" and "loading". (9 weeks ago) <andsel>
7608deecf - Forward port of release notes to 7.x (#12596 & #12648) (#12647) (10 weeks ago) <João Duarte>
de3ee98f8 - [7x backport] Update dockerfile template to allow selection of architecture by env (#12641) (2 months ago) <Rob Bavey>
c96ae0d4b - Fix the run of copyEs and downloadEs gradle task. (#12586) (3 months ago) <andsel>
8abfc50d0 - Fix showing deprecation warning of command line flags (#12592) (#12640) (3 months ago) <kaisecheng>
71b7061b4 - [7x backport] Update docker container tests to handle jvm option parser (#12635) (3 months ago) <Rob Bavey>
cb35193f7 - remove CMS from jvm options in java 14 (#12638) (#12639) (3 months ago) <kaisecheng>
656c2bfd4 - 7x Fix sub second `config.reload.interval` (#12611) (3 months ago) <Rob Bavey>
73154014c - enable agent to stop pipeline by pipeline_id (#12582) (#12616) (3 months ago) <kaisecheng>
ed7fb06a3 - [Doc] added instruction on how to update  and  when an existing LS installation is update to LS 7.12+ and use JDK15 (3 months ago) <andsel>
7e03ce1f5 - Update CI to run on OpenJDK15 (3 months ago) <andsel>
b3bcf29d7 - use correct headers api for redirects in plugin manager http client (#12626) (#12628) (3 months ago) <João Duarte>
91c27cd73 - fix url for kafka and bump to 2.7.0 (#12617) (#12619) (3 months ago) <João Duarte>
0cddeefd9 - Doc: Clarify minimum privileges for logstash_writer role (#12613) (#12623) (3 months ago) <Karen Metts>
d0f1ed4c7 - Revert "replace with_clean_env with with_unbundled_env (#12615) (#12618)" (3 months ago) <Joao Duarte>
ff3cf929f - replace with_clean_env with with_unbundled_env (#12615) (#12618) (3 months ago) <João Duarte>
796f7f83b - bump jrjackson to 0.4.14 and jackson-databind to 2.9.10.8 (#12603) (#12608) (3 months ago) <João Duarte>
f64a60132 - [windows] fix launch of logstash.bat when folder contains spaces (#12585) (#12599) (3 months ago) <João Duarte>
2e4845df3 - Introduction of conditional in jvm.options file (#12530) (3 months ago) <andsel>
b0c81338f - Implements scripted log4j filters and appenders to Java, avoid usage of deprecated Javascript Nashorn (#12512) (3 months ago) <andsel>
87297c5c7 - [forwardport 7.x] Release notes for 7.10.2 (#12553) (3 months ago) <Joao Duarte>
53e73e9cc -  Fix: make sure LS exits when running into fatal errors (#12559) (3 months ago) <Karol Bucek>
98d3ac9d0 - Moved ingest-converter tool from Javascript to Java, preserving the same behaviour (#12524) (3 months ago) <andsel>
e2f2255fa - pq: eliminate corruption by forcing version byte to be persisted (3 months ago) <Ry Biesemeyer>
c5941e634 - Doc: Add info on contributor program (4 months ago) <Karen Metts>
a5dbc8d2a - Update license dependency information (#12544) (4 months ago) <Rob Bavey>
05ec149b3 - Enable javadoc lint only for files that contains javadoc comments, avoid warning for missing javadoc comments on everything else (4 months ago) <andsel>
7704bc78d - Bump 7.12 (#12525) (4 months ago) <Ry Biesemeyer>

=== Logstash Plugin Release Changelogs ===
Computed from "git diff v7.11.2..7.12 *.release"
...
logstash-input-beats: 6.0.14 -> 6.1.2
logstash-input-file: 4.2.3 -> 4.2.4
logstash-input-redis: 3.5.1 -> 3.6.1
logstash-input-tcp: 6.0.7 -> 6.0.9
logstash-input-udp: 3.3.4 -> 3.4.1
...
logstash-output-elasticsearch: 10.8.4 -> 10.8.6
logstash-output-s3: 4.3.3 -> 4.3.4
logstash-patterns-core: 4.1.2 -> 4.3.1
---------- DELETE UP TO HERE ------------
...
* ECS compatibility enablement. Adds `ecs_compatibility` setting to declare the level of ECS compatibility (`disabled` or `v1`) at plugin level. When `disabled`, the plugin behaves like before, while `v1` does a rename of
   `host` and `@metadata.ip_address` event fields. https://github.com/logstash-plugins/logstash-input-beats/pull/404[#404]
